...
Point = function () {
    function Point(x, y, canvas, dia) {_classCallCheck(this, Point);
    ...
    }_createClass(Point, [{ key: 'emit', value: function emit(
        ...
        life) {
            ...
            this.age += 1 / life;
            this.boundary();
        } }, { key: 'boundary', value: function boundary()
        ...
        life) {
            ...
            this.age += 1 / life;
            this.boundary();
        } }, { key: 'shrink', value: function shrink(
...
Particle = function () {function Particle() {_classCallCheck(this, Particle);}_createClass(Particle, [{ key: 'setPosition', value: function setPosition(
...
// Particle Emitter
var Emitter = function (_Particle) {_inherits(Emitter, _Particle);
    function Emitter(x, y, life, mouse, dia) {_classCallCheck(this, Emitter);var _this = _possibleConstructorReturn(this, (Emitter.__proto__ || Object.getPrototypeOf(Emitter)).call(this));
        ...
        _this.life = life || 20;
        _this.canvas = cvs;
        _this.dia = dia || false;return _this;
    }_createClass(Emitter, [{ key: 'animate', value: function animate()
...
// Particle Field
var Field = function (_Particle2) {_inherits(Field, _Particle2);
    function Field(x, y, life) {_classCallCheck(this, Field);var _this2 = _possibleConstructorReturn(this, (Field.__proto__ || Object.getPrototypeOf(Field)).call(this));
    ...
    }_createClass(Field, [{ key: 'animate', value: function animate()
